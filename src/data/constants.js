export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1bRJFsqy56qVBv3NM4oWReMX7ib9STSeI/view?usp=sharing",
...
export const experiences = [
  {
    id: 0,
    img: "https://www.dohertyinc.com/images/DE_Logo_FullColor-v3.png",
    role: "Software Development Engineer Intern 2024",
    company: "Doherty Enterprises, Inc.",
    companyUrl: "https://www.dohertyinc.com",
    date: "June 2024 – August 2024",
    desc: "Collaborated with four QA teams to set project goals and timelines, achieving a 25% faster project completion rate. Automated QA processes, reducing testing time from weeks to less than a day, improving efficiency by 80%. Enhanced QA software frameworks using Java, AWS, and Git, increasing system performance by 30%. Developed and maintained unit and integration tests with full coverage using Selenium, JUnit, TestNG, and Spring Framework, leading to a 40% reduction in bugs.",
    skills: [
      "Java",
      "AWS",
      "Git",
  ...
  },
  {
    ...
    companyUrl: "https://www.qc.cuny.edu",
    date: "Feb 2024 – May 2024",
    desc: "Collaborated with a professor and PhD mentor to create a prediction model for 3D printing data, analyzing 16 samples. Improved prediction accuracy by 35% using ARIMA, Random Forest, and Gradient Boosting algorithms. Applied Explainable AI techniques to clarify model features, enhancing interpretability by 20%. Used NumPy, TensorFlow, and pandas to implement machine learning algorithms, presenting research in Google Colab and Python, improving presentation quality by 15%.",
    skills: [
      "ARIMA",
      "Random Forest",
      "Gradient Boosting",
  ...
  },
  {
    ...
    role: " Software Development Engineer Internship 2023 ",
    company: "PSEG Long Island",
    companyUrl: "https://www.psegliny.com",
  ...
  },
  {
    ...
    role: "Undergraduate Teaching Assistant / Peer Tutor",
    company: "Suffolk County Community College",
    companyUrl: "https://www.sunysuffolk.edu",
    date: "Sep 2022 - Dec 2023",
    desc: "Mentored over 200 undergraduate students semesterly in Data Structures and Algorithms, aiding in coursework and code debugging, improving overall student performance by 25%. Assisted students in overcoming conceptual confusion in lecture material and exam preparation, directing them to appropriate resources, resulting in a 20% increase in exam scores.",
    skills: [
...
export const education = [
  {
    ...
    desc: "Pursuing a Bachelor of Science in Computer Science with a minor in Mathematics. Completing over 140 credit hours, including advanced coursework in algorithms, data structures, and software engineering. Developed and deployed 10+ projects using languages such as Java, Python, and C++. Achieved a GPA of 3.8, demonstrating strong academic performance and technical proficiency.",
...

  {
    ...
    desc: "Earned an Associate of Science degree in Computer Science, focusing on Java, Data Structures, Algorithms, and Computer Architecture. Completed over 60 credit hours, including hands-on MIPS programming. Excelled in advanced mathematics courses such as Calculus, Linear Algebra, and Discrete Mathematics. Graduated with a GPA of 3.9, building a solid foundation for further studies and professional success.",
...
export const projects = [
  ...
  },
  {
    ...
    image:
      "https://machinelearningmastery.com/wp-content/uploads/2017/08/Feed-forward-neural-network-with-two-hidden-layers.png",
